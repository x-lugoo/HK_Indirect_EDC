...
#define IP_ADDRESS_MAX_LEN	    	50   //IP程 //2015-11-23
#define URL_MAX_LEN					50   //URL maximum length
#define PORT_MAX_LEN				5

/*typedef struct _tagCONNECTONE_COMM
{
//#ifdef BEA_SSL
    unsigned char ucEnableSSL;
	unsigned char ucEnableSSL_URL;
    unsigned char szSSL_URL[URL_MAX_LEN];
    unsigned char szSSL_Port[PORT_MAX_LEN];
    unsigned char szSSL_BackupIP[IP_ADDRESS_MAX_LEN];
//#endif //end 

#ifdef PP_SSL   //HASE GENERIC BUILD106
    unsigned char szPP_URL[URL_MAX_LEN];
    unsigned char szPP_Port_DCC[PORT_MAX_LEN]; //Gillian 20160910
	unsigned char szPP_Port_DCD[PORT_MAX_LEN]; //Gillian 20160910
    unsigned char szPP_SSL_BackupIP[IP_ADDRESS_MAX_LEN];
#endif 
} CONNECTONE_COMM;*/
...
#define CT_SSL       7          //ssl      //Gillian 2016-8-23 

#define CT_3G       8//2015-11-23 3G+SSL
...
//#ifdef BEA_SSL 
    unsigned char ucEnableSSL;
	unsigned char ucEnableSSL_URL;
    unsigned char szSSL_URL[URL_MAX_LEN]; //for fubon ssl, redefined by richard 20161209
    unsigned char szSSL_Port[PORT_MAX_LEN];
    unsigned char szSSL_BackupIP[IP_ADDRESS_MAX_LEN];
//#endif //end 
    unsigned char szPP_URL[URL_MAX_LEN];
