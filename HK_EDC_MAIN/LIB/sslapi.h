...
#define ERR_SSL_NO_CLIENT_CERT (33+ERR_SSL_BASE) /*服务器请求证书，但没有本地证书*/
#define ERR_SSL_FUN_PARA (35+ERR_SSL_BASE)/*设参数时，参数错误*/
#define ERR_SSL_NO_CMD (36+ERR_SSL_BASE)/*设参数时，没有相应的命令*/
...
/*   //Gillian 2016-8-17 notessl1
 * 兼容1.0 version API
 *
 */
#define ssl_set_netOps     SslSetNetOps  //SSL1
#define ssl_create         SslCreate   //SSL3
#define ssl_connect        SslConnect  //SSL6
#define ssl_send           SslSend //SSL8
#define ssl_recv           SslRecv //SSL9
#define ssl_close          SslClose //SSL10
#define ssl_certs_set      SslCertsSet //SSL4
#define ssl_certs_release  SslCertsRelease
