...
//Added by LiYuan on 8/10/2006

//VISA 1024 bits Test Key 50
EMV_CAPK capk_visatest_t50={{0xA0,0x00,0x00,0x00,0x03},0x50,
0x01,0x01,128,
...
EMV_CAPK capk_visatest_t51={{0xA0,0x00,0x00,0x00,0x03},0x51,
0x01,0x01,144,
...
EMV_CAPK capk_visatest_t53={{0xA0,0x00,0x00,0x00,0x03},0x53,
0x01,0x01,248,
...
struct{
	...
	{0x98,&capk_visa_t98},
	{0x99,&capk_visa_t99},
	{0x50,&capk_visatest_t50},
	{0x51,&capk_visatest_t51},
	{0x53,&capk_visatest_t53},
...
EMV_APPLIST VISA_VSDC_APP={
	...
	7,PART_MATCH,0,0,0,1,1,1,
#ifdef EMV_TEST_VERSION
	500,0,//2014-12-16 for AMEX CERT test, refer to GP, ori 10000
#else
	0,0,
#endif
	"\x00\x10\x00\x00\x00",
...
void InitLiveApps(void)
{
	...
	iRet = EMVAddApp(&AMEX_LIVE_APP);//2014-12-16 for AMEX CERT test, refer to GP
}
