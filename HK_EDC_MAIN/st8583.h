...
#define	LEN_ICC_DATA2			150//110 //2014-11-10 bit 56 sometimes over flow
#define	LEN_FIELD60				22
#define	LEN_TMSFIELD60			600
#define	LEN_FIELD61				64
#define	LEN_INVOICE_NO			6
#define LEN_FIELD62             800
...
typedef struct _tagSTISO8583
{
	...
	uchar	szFrnAmtPP[LEN_FRN_AMT+2];				// Foreign amt
	uchar	szDccRatePP[LEN_DCC_RATE+2];				// DCC Rate
	...
	uchar	szExtAmount[LEN_EXT_AMOUNT*2+2];		// extra amount // HJJ 20110928 modify
